...
'''
Update (Michael Madelaire, 2025 11 04)

The SSL certificate is depricated as of Python 3.12
I have removed it completely.
Now, SSL certificate verification is handled entirely by the system default 
context, or you can explicitly pass a custom SSL context via context=.
